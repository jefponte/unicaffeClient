...
public class FrameTelaBloqueio extends JFrame {
	...
	public FrameTelaBloqueio() {
		...
		panelPC.setBounds((getWidth() - 415), 12, 220, 43);
		...
		labelNomePC.setBounds(0, 0, 220, 43);
		panelPC.add(labelNomePC);

		JPanel panelPCIcone = new JPanel();
		panelPCIcone.setBounds((getWidth() - 460), 12, 45, 43);
		...
		panelStatus.setBounds((getWidth() - 725), 12, 255, 43);
		...
		panelStatusIcone.setBounds((getWidth() - 770), 12, 45, 43);
